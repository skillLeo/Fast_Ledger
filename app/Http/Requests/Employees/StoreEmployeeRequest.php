...
class StoreEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ni_number' => 'nullable|string|max:9|unique:employees,ni_number',
    ...
    protected function failedValidation(Validator $validator)
    {
        ...
        Log::channel('daily')->error('Employee Validation Failed', [
        ...
        // Log each failed field individually for easier debugging
        foreach ($validator->errors()->messages() as $field => $messages) {
            Log::channel('daily')->warning("Validation Failed: {$field}", [
                'field' => $field,
        ...
        // Continue with default behavior (redirect with errors)
    ...
    public function messages(): array
    {
        return [
            ...
            'ni_number.unique' => 'This National Insurance number is already registered.',
    ...
    protected function prepareForValidation(): void
    {
        ...
        Log::channel('daily')->info('Employee Form Submitted', [
