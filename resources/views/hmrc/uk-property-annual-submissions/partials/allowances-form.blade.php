            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="{{ $fieldPrefix }}[property_income_allowance]" id="{{ $idPrefix }}_property_income_allowance"
                           ...
                           value="{{ old("{$fieldPrefix}.property_income_allowance", $existingData['property_income_allowance'] ?? '') }}"
    ...
    <div id="other-allowances-section">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="{{ $fieldPrefix }}[annual_investment_allowance]" id="{{ $idPrefix }}_annual_investment_allowance"
                           ...
                           value="{{ old("{$fieldPrefix}.annual_investment_allowance", $existingData['annual_investment_allowance'] ?? '') }}"
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="{{ $fieldPrefix }}[business_premises_renovation_allowance]" id="{{ $idPrefix }}_business_premises_renovation_allowance"
                           ...
                           value="{{ old("{$fieldPrefix}.business_premises_renovation_allowance", $existingData['business_premises_renovation_allowance'] ?? '') }}"
                           step="0.01" min="0" max="99999999999.99"
                           placeholder="0.00">
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="{{ $fieldPrefix }}[other_capital_allowance]" id="{{ $idPrefix }}_other_capital_allowance"
                           ...
                           value="{{ old("{$fieldPrefix}.other_capital_allowance", $existingData['other_capital_allowance'] ?? '') }}"
                           step="0.01" min="0" max="99999999999.99"
                           placeholder="0.00">
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="{{ $fieldPrefix }}[cost_of_replacing_domestic_goods]" id="{{ $idPrefix }}_cost_of_replacing_domestic_goods"
                           ...
                           value="{{ old("{$fieldPrefix}.cost_of_replacing_domestic_goods", $existingData['cost_of_replacing_domestic_goods'] ?? '') }}"
                           step="0.01" min="0" max="99999999999.99"
                           placeholder="0.00">
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="{{ $fieldPrefix }}[zero_emissions_car_allowance]" id="{{ $idPrefix }}_zero_emissions_car_allowance"
                           ...
                           value="{{ old("{$fieldPrefix}.zero_emissions_car_allowance", $existingData['zero_emissions_car_allowance'] ?? '') }}"
                           step="0.01" min="0" max="99999999999.99"
                           placeholder="0.00">
                </div>
            ...
            <div class="col-md-6 pre-ty-2024-25-field">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="{{ $fieldPrefix }}[zero_emissions_goods_vehicle_allowance]" id="{{ $idPrefix }}_zero_emissions_goods_vehicle_allowance"
                           ...
                           value="{{ old("{$fieldPrefix}.zero_emissions_goods_vehicle_allowance", $existingData['zero_emissions_goods_vehicle_allowance'] ?? '') }}"
                           step="0.01" min="0" max="99999999999.99"
                           placeholder="0.00">
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="{{ $fieldPrefix }}[electric_charge_point_allowance]" id="{{ $idPrefix }}_electric_charge_point_allowance"
                           ...
                           value="{{ old("{$fieldPrefix}.electric_charge_point_allowance", $existingData['electric_charge_point_allowance'] ?? '') }}"
                           step="0.01" min="0" max="99999999999.99"
                           placeholder="0.00">
                </div>
        ...
        <div class="ty-2024-25-fields mt-5" style="display: none;">
            ...
            <div id="sba-container-{{ $propertyType ?? 'default' }}">
                ...
                @if(!empty($existingData['structured_building_allowance']) && is_array($existingData['structured_building_allowance']))
                    @foreach($existingData['structured_building_allowance'] as $index => $sba)
                        <div class="building-allowance-card mb-3">
                            <div class="card">
                                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0">Structured Building Allowance #{{ $index + 1 }}</h6>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">£</span>
                                                <input type="number" name="{{ $fieldPrefix }}[structured_building_allowance][{{ $index }}][amount]"
                                                       class="form-control" required value="{{ $sba['amount'] ?? '' }}"
                                                       step="0.01" min="0" max="99999999999.99" placeholder="0.00">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">First Year Qualifying Date</label>
                                            <input type="date" name="{{ $fieldPrefix }}[structured_building_allowance][{{ $index }}][first_year_qualifying_date]"
                                                   class="form-control" value="{{ $sba['first_year_qualifying_date'] ?? '' }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">First Year Qualifying Amount</label>
                                            <div class="input-group">
                                                <span class="input-group-text">£</span>
                                                <input type="number" name="{{ $fieldPrefix }}[structured_building_allowance][{{ $index }}][first_year_qualifying_amount]"
                                                       class="form-control" value="{{ $sba['first_year_qualifying_amount'] ?? '' }}"
                                                       step="0.01" min="0" max="99999999999.99" placeholder="0.00">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Building Name</label>
                                            <input type="text" name="{{ $fieldPrefix }}[structured_building_allowance][{{ $index }}][building_name]"
                                                   class="form-control" maxlength="255" value="{{ $sba['building_name'] ?? '' }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Building Number</label>
                                            <input type="text" name="{{ $fieldPrefix }}[structured_building_allowance][{{ $index }}][building_number]"
                                                   class="form-control" maxlength="255" value="{{ $sba['building_number'] ?? '' }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Building Postcode</label>
                                            <input type="text" name="{{ $fieldPrefix }}[structured_building_allowance][{{ $index }}][building_postcode]"
                                                   class="form-control" maxlength="10" placeholder="SW1A 1AA" value="{{ $sba['building_postcode'] ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="ty-2024-25-fields mt-4" style="display: none;">
            ...
            <div id="esba-container-{{ $propertyType ?? 'default' }}">
                ...
                @if(!empty($existingData['enhanced_structured_building_allowance']) && is_array($existingData['enhanced_structured_building_allowance']))
                    @foreach($existingData['enhanced_structured_building_allowance'] as $index => $esba)
                        <div class="building-allowance-card mb-3">
                            <div class="card">
                                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0">Enhanced Structured Building Allowance #{{ $index + 1 }}</h6>
                                    <button type="button" class="btn btn-sm btn-outline-danger remove-building" onclick="this.closest('.building-allowance-card').remove();">
                                        <i class="fas fa-trash"></i> Remove
                                    </button>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">£</span>
                                                <input type="number" name="{{ $fieldPrefix }}[enhanced_structured_building_allowance][{{ $index }}][amount]"
                                                       class="form-control" required value="{{ $esba['amount'] ?? '' }}"
                                                       step="0.01" min="0" max="99999999999.99" placeholder="0.00">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">First Year Qualifying Date</label>
                                            <input type="date" name="{{ $fieldPrefix }}[enhanced_structured_building_allowance][{{ $index }}][first_year_qualifying_date]"
                                                   class="form-control" value="{{ $esba['first_year_qualifying_date'] ?? '' }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">First Year Qualifying Amount</label>
                                            <div class="input-group">
                                                <span class="input-group-text">£</span>
                                                <input type="number" name="{{ $fieldPrefix }}[enhanced_structured_building_allowance][{{ $index }}][first_year_qualifying_amount]"
                                                       class="form-control" value="{{ $esba['first_year_qualifying_amount'] ?? '' }}"
                                                       step="0.01" min="0" max="99999999999.99" placeholder="0.00">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Building Name</label>
                                            <input type="text" name="{{ $fieldPrefix }}[enhanced_structured_building_allowance][{{ $index }}][building_name]"
                                                   class="form-control" maxlength="255" value="{{ $esba['building_name'] ?? '' }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Building Number</label>
                                            <input type="text" name="{{ $fieldPrefix }}[enhanced_structured_building_allowance][{{ $index }}][building_number]"
                                                   class="form-control" maxlength="255" value="{{ $esba['building_number'] ?? '' }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Building Postcode</label>
                                            <input type="text" name="{{ $fieldPrefix }}[enhanced_structured_building_allowance][{{ $index }}][building_postcode]"
                                                   class="form-control" maxlength="10" placeholder="SW1A 1AA" value="{{ $esba['building_postcode'] ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
