    ...
    <div class="container-fluid mt-4">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Amend</li>
            </ol>
        </nav>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0 text-gray-800">
                    <i class="fas fa-pen text-warning me-2"></i>Amend UK Property Period Summary
                </h1>
        ...
        <form id="period-summary-form" method="POST" action="{{ route('hmrc.uk-property-period-summaries.amend-submit', $summary) }}">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex justify-content-between mb-4">
                ...
                <button type="submit" class="btn btn-warning" onclick="return confirm('Are you sure you want to submit this amendment to HMRC? This will replace the existing submission.');">
                    <i class="fas fa-paper-plane me-2"></i> Submit Amendment to HMRC
                </button>
            </div>
        </form>
    </div>
