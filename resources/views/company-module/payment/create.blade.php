                ...
                <div class="mb-4">
                    ...
                    @if(!$pricing['is_upgrade'])
                        <div class="d-flex align-items-center gap-2 mt-3">
                            ...
                            <span class="badge bg-success-subtle text-success border border-success">✓ Company Created</span>
                            <div style="width: 30px; height: 2px; background: #dee2e6;"></div>
                        ...
                        <div class="col-xl-7">
                            ...
                            @if($pricing['is_upgrade'])
                                <div class="mb-4 p-3 bg-light rounded-3">
                                    ...
                                    <strong>{{ $pricing['current_companies'] }} {{ Str::plural('company', $pricing['current_companies']) }}</strong>
                                    <span class="text-muted">= {{ $pricing['currency'] }}{{ $pricing['current_companies'] * $pricing['price_per_company'] }}/month</span>
                                </div>
                            @endif
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <input class="btn-check" 
                                                   ...
                                                   value="trial" 
                                                   checked>
                                            <label class="btn btn-outline-success w-100 text-start p-4" for="free_trial" style="border: 3px solid #198754; height: 100%;">
                                                <div class="mb-2">
                                                ...
                                                <ul class="mb-0 small ps-3">
                                                    ...
                                                    <li>Card required (no charge now)</li>
                                                    <li>Cancel anytime during trial</li>
                                                    <li>Auto-charge after 14 days</li>
                                                </ul>
                                            </label>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <input class="btn-check" 
                                                   ...
                                                   id="pay_now" 
                                                   value="paid">
                                            <label class="btn btn-outline-primary w-100 text-start p-4" for="pay_now" style="border: 2px solid #e0e0e0; height: 100%;">
                                                <div class="mb-2">
                                                    <h6 class="fw-bold mb-1">Pay Now</h6>
                                                </div>
                                                <ul class="mb-0 small ps-3">
                                                    <li>Skip trial, pay today</li>
                                                    <li>Immediate full access</li>
                                                    <li>Get 20% off yearly plan</li>
                                                </ul>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="button" class="btn btn-outline-secondary" onclick="decrementCompanies()" style="width: 40px; height: 40px; padding: 0;">−</button>
                                        <input type="number" 
                                               name="additional_companies" 
                                               ...
                                               required>
                                        <button type="button" class="btn btn-outline-secondary" onclick="incrementCompanies()" style="width: 40px; height: 40px; padding: 0;">+</button>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <p class="text-muted small mb-3">
                                        <span id="billing_description">
                                            @if(!$pricing['is_upgrade'] && $pricing['can_use_trial'])
                                                You'll be charged after your 14-day free trial ends.
                                            @else
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <input class="btn-check" 
                                                   ...
                                                   value="monthly" 
                                                   checked>
                                            <label class="btn btn-outline-primary w-100 text-start p-3" for="monthly" style="border: 2px solid #e0e0e0;">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-muted small" id="monthlyRecurring">
                                                            {{ $pricing['currency'] }}{{ $pricing['price_per_company'] }} per seat / month
                                                        </div>
                                                    </div>
                                                </div>
                                            </label>
                                        ...
                                        <div class="col-md-6">
                                            <input class="btn-check" 
                                                   ...
                                                   id="yearly" 
                                                   value="yearly">
                                            <label class="btn btn-outline-primary w-100 text-start p-3" for="yearly" style="border: 2px solid #e0e0e0;">
                                                <div class="d-flex align-items-center">
                                                    <div class="form-check-input-custom me-3"></div>
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <div class="text-muted small" id="yearlyRecurring">
                                                            {{ $pricing['currency'] }}{{ round($pricing['price_per_company'] * 0.8, 2) }} per seat / month
                                                        </div>
                                                    </div>
                                                </div>
                                            </label>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="card-element" class="form-control" style="height: 50px; padding: 15px; border: 2px solid #e0e0e0;">
                                        <!-- Stripe card element -->
                                    </div>
                                ...
                                {{-- ✅ Free Trial Notice --}}
                                <div id="trial_notice" class="alert alert-info border-info" style="display: @if(!$pricing['is_upgrade'] && $pricing['can_use_trial']) block @else none @endif;">
                                    <div class="d-flex">
                                        <i class="ri-information-line me-2 fs-5"></i>
                                        <div>
                                            <strong>Your card won't be charged today</strong>
                                            <p class="mb-0 small">We'll only charge you <strong id="trial_charge_amount">{{ $pricing['currency'] }}{{ $pricing['price_per_company'] }}</strong> after your 14-day free trial ends. Cancel anytime before then at no cost.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 shadow-sm" style="position: sticky; top: 20px;">
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-flex align-items-start mb-4 pb-4 border-bottom">
                                        <div class="bg-dark rounded me-3" style="width: 48px; height: 48px; flex-shrink: 0;"></div>
                                        <div>
                                    ...
                                    @if($pricing['is_upgrade'])
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex justify-content-between mb-3 text-success">
                                                <span>+ <span id="addCount">1</span> <span id="addText">company</span></span>
                                                <span>+{{ $pricing['currency'] }}<span id="addPrice">{{ $pricing['price_per_company'] }}</span></span>
                                            </div>
                                        </div>
                                    @else
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <span>{{ $pricing['currency'] }}<span id="subPrice">{{ $pricing['price_per_company'] }}</span></span>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="mb-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="text-end">
                                                <div class="h4 fw-bold mb-0">{{ $pricing['currency'] }}<span id="paymentAmountValue">0</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4 p-3 bg-light rounded-3">
                                        ...
                                        <ul class="mb-0 small text-muted ps-3">
                                            <li id="trial_feature" style="display: @if(!$pricing['is_upgrade'] && $pricing['can_use_trial']) block @else none @endif;">14-day free trial</li>
                                    ...
                                    {{-- Action Button --}}
                                    <button type="submit" id="submit-button" class="btn btn-dark w-100 py-3 fw-semibold">
                                        <span id="button-text">
                                            <span id="button_text_content">Start Free Trial</span>
                                        </span>
                                        <span id="spinner" class="spinner-border spinner-border-sm d-none"></span>
                                    </button>

                                    <div class="text-center mt-3">
                                        <a href="{{ route('company.select') }}" class="text-muted small text-decoration-none">Cancel</a>
                                    </div>
...
<script>
    ...
    function updateUI() {
        const isTrial = freeTrialRadio && freeTrialRadio.checked;
        const isYearly = yearlyRadio.checked;
        
        const trialNotice = document.getElementById('trial_notice');
        if (trialNotice) {
            trialNotice.style.display = (isTrial && !isUpgrade) ? 'block' : 'none';
        }

        const trialBadge = document.getElementById('trial_badge');
        if (trialBadge) {
            trialBadge.textContent = isTrial ? '14-day free trial' : '';
        }

        const trialFeature = document.getElementById('trial_feature');
        if (trialFeature) {
            trialFeature.style.display = isTrial ? 'block' : 'none';
        }

        const buttonTextContent = document.getElementById('button_text_content');
        if (buttonTextContent) {
            if (isTrial && !isUpgrade) {
                buttonTextContent.textContent = 'Start Free Trial';
            } else {
                const additionalCompanies = parseInt(input.value) || 1;
                const totalMonthlyCost = isUpgrade 
                    ? (additionalCompanies * pricePerCompany)
                    : (additionalCompanies * pricePerCompany);
                const discount = isYearly ? 0.2 : 0;
                const paymentAmount = isYearly 
                    ? Math.round(totalMonthlyCost * 12 * (1 - discount) * 100) / 100
                    : totalMonthlyCost;
                buttonTextContent.textContent = `Pay ${currency}${paymentAmount}`;
            }
        }
        ...
        if (billingDesc) {
            if (isTrial && !isUpgrade) {
                billingDesc.textContent = "You'll be charged after your 14-day free trial ends.";
            } else {
                billingDesc.textContent = "Pay annually for a 20% discount.";
            }
        }
    }

    if (freeTrialRadio) freeTrialRadio.addEventListener('change', updateUI);
    if (payNowRadio) payNowRadio.addEventListener('change', updateUI);
    ...
    function updatePricing() {
        ...
        if (isUpgrade) {
            ...
            const additionalMonthlyCost = additionalCompanies * pricePerCompany;
            ...
            const totalMonthlyCost = additionalCompanies * pricePerCompany;
            ...
            if (isTrial) {
                ...
                const trialChargeAmt = document.getElementById('trial_charge_amount');
                if (trialChargeAmt) {
                    const futureCharge = isYearly 
                        ? Math.round(totalMonthlyCost * 12 * (1 - discount) * 100) / 100
                        : totalMonthlyCost;
                    trialChargeAmt.textContent = `${currency}${futureCharge}`;
                }
            } else {
                const monthlyPayment = totalMonthlyCost;
                const yearlyPayment = Math.round(totalMonthlyCost * 12 * (1 - discount) * 100) / 100;
                displayAmount = isYearly ? yearlyPayment : monthlyPayment;
                discountAmt = isYearly ? Math.round(totalMonthlyCost * 12 * discount * 100) / 100 : 0;
            ...
            document.getElementById('subPrice').textContent = totalMonthlyCost;
        ...
        document.getElementById('monthlyRecurring').textContent = `${currency}${perSeatMonthly} per seat / month`;
        document.getElementById('yearlyRecurring').textContent = `${currency}${perSeatYearly} per seat / month`;
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const additionalCompanies = parseInt(input.value);
        ...
        const isTrial = paymentOption === 'trial';
        const discount = isYearly ? 0.2 : 0;
        
        const totalCompanies = isUpgrade ? (currentCompanies + additionalCompanies) : additionalCompanies;
        const additionalMonthlyCost = isUpgrade ? (additionalCompanies * pricePerCompany) : (additionalCompanies * pricePerCompany);
        
        // ✅ Calculate ACTUAL charge amount
        let chargeAmount = 0;
        if (!isTrial || isUpgrade) {
            chargeAmount = isYearly 
                ? Math.round(additionalMonthlyCost * 12 * (1 - discount) * 100) / 100
                : additionalMonthlyCost;
        }

        try {
            // ✅ STEP 1: Create Payment Method (ALWAYS - even for £0 trial)
            ...
            // ✅ STEP 2: Setup Payment Intent (saves card even for £0)
            const setupResponse = await fetch('{{ route("company.payment.create-intent") }}', {
                ...
                body: JSON.stringify({
                    ...
                    payment_method_id: paymentMethod.id, // ✅ Send payment method
                }),
            });
            ...
            if (!setupData.success) {
                throw new Error(setupData.error || 'Failed to setup payment');
            }

            console.log('✅ Payment Intent Response:', setupData);

            let paymentIntentId = null;

            // ✅ STEP 3: If charging now (not trial), confirm payment
