                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header">
                            <h4 class="page-title">{{ __('company.edit_customer') }}</h4>
                        </div>

                        <form method="POST" action="{{ route('company.customers.update', [$company, $customer]) }}" id="customerForm">
                            @csrf
                            @method('PUT')
                                            ...
                                            <div class="row g-2">
                                                    ...
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <div class="radio-group mb-2">
                                                            <input type="radio" id="customer_type_individual" name="Customer_Type" 
                                                                value="Individual" {{ old('Customer_Type', $customer->Customer_Type) == 'Individual' ? 'checked' : '' }}>
                                                        ...
                                                        <div class="radio-group">
                                                            <input type="radio" id="customer_type_company" name="Customer_Type" 
                                                                value="Company" {{ old('Customer_Type', $customer->Customer_Type) == 'Company' ? 'checked' : '' }}>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <input type="text" id="Company_Name" name="Legal_Name_Company" 
                                                                    ...
                                                                    value="{{ old('Legal_Name_Company_Name', $customer->Legal_Name_Company_Name) }}">
                                                ...
                                                <div class="col-12">
                                                    <div class="row g-2">
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <select id="Tax_ID_Type" name="Tax_ID_Type"
                                                                    ...
                                                                    <option value="NIF" {{ old('Tax_ID_Type', $customer->Tax_ID_Type) == 'NIF' ? 'selected' : '' }}>{{ __('company.nif') }}</option>
                                                                    <option value="CIF" {{ old('Tax_ID_Type', $customer->Tax_ID_Type) == 'CIF' ? 'selected' : '' }}>{{ __('company.cif') }}</option>
                                                                    <option value="NIE" {{ old('Tax_ID_Type', $customer->Tax_ID_Type) == 'NIE' ? 'selected' : '' }}>{{ __('company.nie') }}</option>
                                                                    <option value="EU_VAT" {{ old('Tax_ID_Type', $customer->Tax_ID_Type) == 'EU_VAT' ? 'selected' : '' }}>{{ __('company.eu_vat') }}</option>
                                                                </select>
                                                                @error('Tax_ID_Type')
                                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-md-6" id="tax_id_number_wrapper">
                                                            <div class="form-group mb-2">
                                                                ...
                                                                <input type="text" id="Tax_ID_Number" name="Tax_ID_Number" 
                                                                    ...
                                                                    value="{{ old('Tax_ID_Number', $customer->Tax_ID_Number) }}" 
                                    ...
                                    <div class="h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-2">
                                                ...
                                                @php
                                                    $taxType = 'None';
                                                    if($customer->Has_VAT) $taxType = 'VAT';
                                                    if($customer->Has_IRPF) $taxType = 'IRPF';
                                                @endphp
                                                ...
                                                <div class="col-12" id="vat_rate_wrapper" style="display: none;">
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <select id="VAT_Rate" name="VAT_Rate"
                                                            ...
                                                            <option value="Standard_21" {{ old('VAT_Rate', $customer->VAT_Rate) == 'Standard_21' ? 'selected' : '' }}>{{ __('company.standard_21') }}</option>
                                                            <option value="Reduced_10" {{ old('VAT_Rate', $customer->VAT_Rate) == 'Reduced_10' ? 'selected' : '' }}>{{ __('company.reduced_10') }}</option>
                                                            <option value="Super_Reduced_4" {{ old('VAT_Rate', $customer->VAT_Rate) == 'Super_Reduced_4' ? 'selected' : '' }}>{{ __('company.super_reduced_4') }}</option>
                                                            <option value="Exempt_0" {{ old('VAT_Rate', $customer->VAT_Rate) == 'Exempt_0' ? 'selected' : '' }}>{{ __('company.exempt_0') }}</option>
                                                            <option value="Intra_EU" {{ old('VAT_Rate', $customer->VAT_Rate) == 'Intra_EU' ? 'selected' : '' }}>{{ __('company.intra_eu') }}</option>
                                                            <option value="Export" {{ old('VAT_Rate', $customer->VAT_Rate) == 'Export' ? 'selected' : '' }}>{{ __('company.export') }}</option>
                                                        </select>
                                                        @error('VAT_Rate')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-12" id="irpf_rate_wrapper" style="display: none;">
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <select id="IRPF_Rate" name="IRPF_Rate"
                                                            ...
                                                            <option value="7" {{ old('IRPF_Rate', $customer->IRPF_Rate) == '7' ? 'selected' : '' }}>{{ __('company.irpf_7') }}</option>
                                                            <option value="15" {{ old('IRPF_Rate', $customer->IRPF_Rate) == '15' ? 'selected' : '' }}>{{ __('company.irpf_15') }}</option>
                                                        </select>
                                                        @error('IRPF_Rate')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <input type="hidden" name="Has_VAT" id="Has_VAT" value="{{ $customer->Has_VAT ? '1' : '0' }}">
                                                <input type="hidden" name="Has_IRPF" id="Has_IRPF" value="{{ $customer->Has_IRPF ? '1' : '0' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <div class="radio-group mb-2">
                                                        <input type="radio" id="payment_bank_transfer" name="Payment_Method" 
                                                            value="Bank_Transfer" {{ old('Payment_Method', $customer->Payment_Method) == 'Bank_Transfer' ? 'checked' : '' }}>
                                                        <label for="payment_bank_transfer">{{ __('company.bank_transfer') }}</label>
                                                    </div>
                                                    
                                                    <div class="radio-group">
                                                        <input type="radio" id="payment_cash" name="Payment_Method" 
                                                            value="Cash" {{ old('Payment_Method', $customer->Payment_Method) == 'Cash' ? 'checked' : '' }}>
                            ...
                            <div class="row mt-3 mb-3">
                                <div class="col-12 text-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">{{ __('company.update_customer') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
